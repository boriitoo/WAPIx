...
class SessionsService {
    constructor() {
        this.repository = data_source_1.AppDataSource.getRepository(session_1.Session);
    }
    list() {
    ...
    deleteByName(name) {
        return __awaiter(this, void 0, void 0, function* () {
            const session = yield this.getByName(name);
            if (!session) {
                return false;
            }
            yield this.repository.delete(session);
            return true;
        });
    }
    updateConnectivityByName(name, connected) {
        return __awaiter(this, void 0, void 0, function* () {
            const session = yield this.getByName(name);
            if (!session) {
                return;
